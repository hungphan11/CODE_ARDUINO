...
// Chân mới cho SDA và SCL
#define OLED_SDA      D3  // Chân SDA (thay đổi theo yêu cầu)
#define OLED_SCL      D1  // Chân SCL (thay đổi theo yêu cầu)
...
#define ss D8        // Chân NSS (GPIO D8)
#define rst D0    // Chân RST (GPIO D0)
#define dio0 D2     // Chân DIO0 (GPIO D1)

//---------------------------------------- SPI Pin configuration
#define MISO D6      // Chân MISO (GPIO D6)
#define MOSI D7      // Chân MOSI (GPIO D7)
#define SCK  D5      // Chân SCK (GPIO D5)
...
void Processing_incoming_data() {
  if (Incoming == "SDS2") {  // SDS1 or SDS2 sent from Master
    ...
    Message = "";
    Message = String(h) + ":" + String(t) + ":" + String(soilMoisture);
...
void setup() {
  ...
  // Khởi tạo giao tiếp I2C với các chân SDA và SCL tùy chỉnh
